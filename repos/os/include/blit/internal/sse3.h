...
void Blit::Sse3::B2f::r0(uint32_t       *dst, unsigned line_w,
...
void Blit::Sse3::B2f::r90(uint32_t       *dst, unsigned dst_w,
...
void Blit::Sse3::B2f::r180(uint32_t       *dst, unsigned line_w,
                           uint32_t const *src, unsigned w, unsigned h)
{
	__m128i       *d = (__m128i *)dst;
...
void Blit::Sse3::B2f::r270(uint32_t       *dst, unsigned dst_w,
                           uint32_t const *src, unsigned src_w,
                           unsigned w, unsigned h)
{
	Steps const steps { 2*int(src_w), -2*int(dst_w) };
...
void Blit::Sse3::B2f_flip::r0(uint32_t       *dst, unsigned line_w,
                              uint32_t const *src, unsigned w, unsigned h)
{
	__m128i const *s = (__m128i const *)src;
	__m128i       *d = (__m128i       *)dst;
...
void Blit::Sse3::B2f_flip::r90(uint32_t       *dst, unsigned dst_w,
                               uint32_t const *src, unsigned src_w,
                               unsigned w, unsigned h)
{
	Steps const steps { 2*int(src_w), 2*int(dst_w) };
...
void Blit::Sse3::B2f_flip::r180(uint32_t       *dst, unsigned line_w,
                                uint32_t const *src, unsigned w, unsigned h)
{
	__m128i const *s = (__m128i const *)src + 2*line_w*8*h;
	__m128i       *d = (__m128i       *)dst;
...
void Blit::Sse3::B2f_flip::r270(uint32_t       *dst, unsigned dst_w,
                                uint32_t const *src, unsigned src_w,
                                unsigned w, unsigned h)
{
	Steps const steps { -2*int(src_w), -2*int(dst_w) };
