...
#ifndef _GEN_UPDATE_H_
#define _GEN_UPDATE_H_

#include "xml.h"

namespace Sculpt_manager { void gen_update_start_content(Xml_generator &); }


void Sculpt_manager::gen_update_start_content(Xml_generator &xml)
{
	...
	xml.node("route", [&] () {
		...
		gen_parent_rom_route(xml, "installation", "config -> installation");
