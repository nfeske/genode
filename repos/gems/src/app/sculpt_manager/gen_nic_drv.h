...
#ifndef _GEN_NIC_DRV_H_
#define _GEN_NIC_DRV_H_

#include "xml.h"

namespace Sculpt_manager { void gen_nic_drv_start_content(Xml_generator &); }


void Sculpt_manager::gen_nic_drv_start_content(Xml_generator &xml)
{
