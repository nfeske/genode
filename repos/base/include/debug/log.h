 ...
 *
 * The macro captures the TSC ticks spent in the current scope. Every 'n'
 * calls, it prints the statistics about the accumulated cycles spent and the
 * total number of calls. For example,
 *
 ...
 * ticks.
 *
 * The argument 'n' allows for the tuning of the amount of output depending on
 * the instrumented function. For example,
 */
