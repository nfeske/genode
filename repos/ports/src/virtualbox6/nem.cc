...
int nemR3NativeInit(PVM pVM, bool fFallback, bool fForced) STOP


int nemR3NativeInitAfterCPUM(PVM pVM) STOP
...
int nemR3NativeNotifyPhysRamRegister(PVM pVM, RTGCPHYS GCPhys, RTGCPHYS cb) STOP
